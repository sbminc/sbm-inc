  ...
  return (
    <section className="py-20 md:py-32 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="bg-gradient-to-r from-deep-blue to-midnight-blue rounded-3xl p-10 md:p-16 text-white text-center relative overflow-hidden shadow-2xl">
          {/* Shiny overlay */}
          ...
          <div
            className="absolute bottom-0 right-1/4 w-40 h-40 bg-orange/20 rounded-full blur-xl animate-pulse"
