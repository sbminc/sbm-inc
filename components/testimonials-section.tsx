...
export default function TestimonialsSection() {
  ...
  const [stars, setStars] = useState<Array<{ top: number; left: number; width: number; height: number; duration: number }>>([])
  ...
  if (!mounted) {
    ...
    return (
      <section className="py-20 md:py-32 relative bg-gradient-to-b from-burgundy/80 to-midnight-blue/90 overflow-hidden">
