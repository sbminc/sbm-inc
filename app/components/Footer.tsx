      ...
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-3">
            <Image src="/logo.png" alt="SBM Inc." width={48} height={48} className="rounded-full" />
            <h3 className="text-xl font-bold">SBM Inc.</h3>
          </div>
        ...
        {/* Programs */}
        <div>
          <h3 className="text-xl font-bold mb-4 text-gold">Programs</h3>
          <ul className="space-y-2">
            <li><Link href="/programs#mentorship" className="hover:text-gold transition-colors">Mentorship Program</Link></li>
            <li><Link href="/programs#leadership" className="hover:text-gold transition-colors">Leadership Workshop</Link></li>
            <li><Link href="/programs#academic" className="hover:text-gold transition-colors">Academic Support</Link></li>
            <li><Link href="/programs#community" className="hover:text-gold transition-colors">Community Service</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li className="flex items-center space-x-2">
              ...
              <span>Volusia County, Florida</span>
            </li>
            <li className="flex items-center space-x-2">
              <svg className="h-5 w-5 text-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              <a href="mailto:info@sbminc.org" className="hover:text-gold transition-colors">info@sbminc.org</a>
            </li>
            <li className="flex items-center space-x-2">
              <svg className="h-5 w-5 text-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
